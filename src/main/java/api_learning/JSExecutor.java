...
public class JSExecutor {
    ...
    private static final String SCROLL_TO_BOTTOM_JS_SNIPPET = "window.scrollTo(0, document.body.scrollHeight)";
    private static final String SCROLL_TO_TOP_JS_SNIPPET = "window.scrollTo(document.body.scrollHeight, 0)";
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            javascriptExecutor.executeScript(SCROLL_TO_BOTTOM_JS_SNIPPET);

            // Scroll to top
            javascriptExecutor.executeScript(SCROLL_TO_TOP_JS_SNIPPET);
