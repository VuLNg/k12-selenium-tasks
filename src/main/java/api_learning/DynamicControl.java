...
public class DynamicControl {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            WebElement inputFormEls = driver.findElement(INPUT_FORM_SEL);
            ...
            WebElement enableTextFieldBtn = inputFormEls.findElement(BTN_ELE_SEL);
            WebElement textFieldEle = inputFormEls.findElement(INPUT_ELE_SEL);
            System.out.println("\n\nBEFORE | Is element selected: " + textFieldEle.isEnabled());
